...
### 5. 연말정산 세액공제
- 월세와 전세대출 관련 공제 가능 금액을 간이 계산

### 6. DSR/DTI 계산
- 연소득 대비 대출 상환 부담을 비율로 확인

### 7. 중개보수 계산
- 매매와 임대차 중개보수 상한을 빠르게 확인

### 8. 취득세 계산
- 취득가액, 보유 주택 수, 지역 조건으로 간이 계산
...
- 새로운 계산기, 저장/공유 기능, 계정/알림 관련 기능을 추가할 때는 `lib/features/settings/app_guide_screen.dart`의 사용자 가이드도 함께 갱신합니다.
- 기능 소개, 입력 흐름, 결과 해석, 주의사항은 앱 화면의 설명과 README의 주요 기능 목록이 서로 어긋나지 않게 맞춥니다.
