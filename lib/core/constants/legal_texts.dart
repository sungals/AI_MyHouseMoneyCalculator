    ...
    sections: [
      LegalSection(
        ...
        paragraphs: [
          ...
          '비밀번호와 생체인증 원본 정보는 앱 서버에 직접 저장하지 않습니다. 비밀번호 인증은 Supabase Auth를 통해 처리되며, 생체인증은 기기 운영체제의 인증 기능을 사용합니다.',
        ],
      ),
      LegalSection(
      ...
      LegalSection(
        ...
        paragraphs: [
          ...
          '서버 저장: 로그인한 사용자가 계산 결과를 저장하거나 동기화 기능을 사용할 경우 계산 데이터와 계정 식별자가 Supabase에 저장됩니다.',
        ],
      ),
      LegalSection(
        title: '7. 사용자의 권리',
